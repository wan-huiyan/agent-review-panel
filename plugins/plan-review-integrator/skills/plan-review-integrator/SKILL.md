...
**Compatible with:** `agent-review-panel` v2.0+ (v2.9+ for VoltAgent-enriched findings, v2.16.1+ ships in the same `agent-review-panel` marketplace bundle as this plugin — install both with `/plugin install agent-review-panel@agent-review-panel` + `/plugin install plan-review-integrator@agent-review-panel`)
