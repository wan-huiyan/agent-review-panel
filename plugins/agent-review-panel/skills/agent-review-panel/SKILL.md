...
- HTML footer should read "Agent Review Panel v2.16.6" (MUST match the full semver from `plugin.json` — update this line whenever the version is bumped)
