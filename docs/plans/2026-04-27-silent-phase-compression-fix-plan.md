...
`the-project-repo` PR #117 (the corrective full-run input from
...
- [ ] **Step 14.6: Diff against the project#117**

Compare the v3.1.0 run's findings count against the project#117's corrective
...
the findings-count diff vs. the project#117.
...
- [ ] Manual: findings count matches the project#117 corrective report
