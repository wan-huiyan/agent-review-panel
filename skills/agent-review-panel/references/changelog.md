...
- **A/B validated** — full panel run on same document (the client enrollment plan) produced identical verdict (4/10) with marginal improvements in checklist discipline (+2 findings) and judge structure (P0/P1/P2 tiers). See `docs/v25-vs-v26-comparison.md`.
